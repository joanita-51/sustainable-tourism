  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#f8f6f6]">
      <form className="w-full max-w-sm" onSubmit={handleSubmit}>
        <p className="text-3xl font-bold text-center pt-12 mb-3">Sign Up</p>
        ...
        <div className="mb-4">
          ...
          <span className='ms-5'>Already have an account? <Link className='text-[#EB1D36]' to="/login">Login</Link></span>
        </div>
      </form>
    </div>
  );
